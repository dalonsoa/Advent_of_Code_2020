...
fn sum_two_nums(num: &i32, numbers: &[i32], target: &i32) -> i32 {
...
/// add up to a third one. If found, return their product. Otherwise, return zero.
fn sum_three_nums(num: &i32, numbers: &[i32], target: &i32) -> i32 {
...
fn main() {
    ...
    println!("Two numbers: {:?}", sum_two_nums(&numbers[0], &numbers[..], &2020));
    println!("Three numbers: {:?}", sum_three_nums(&numbers[0], &numbers[..], &2020));
}
